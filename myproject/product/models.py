...
class Hotel(models.Model):
    ...
    foto1 = models.CharField('Фото1')
    foto2 = models.CharField('Фото2')
    foto3 = models.CharField('Фото3')
    foto4 = models.CharField('Фото4')
    foto5 = models.CharField('Фото5')
...
class Room(models.Model):
    ...
    room_name = models.CharField('Название комнаты', max_length=50)
