...
class HotelAdmin(admin.ModelAdmin):
    list_display = ('name', 'address', 'contact_phone', 'email', 'rating', 'foto1', 'foto2', 'foto3', 'foto4', 'foto5')
    fields = ('name', 'address', 'contact_phone', 'email', 'description', 'rating', 'foto1', 'foto2', 'foto3', 'foto4', 'foto5')
